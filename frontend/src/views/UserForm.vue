<template>
    ...
    <div class="user-form">
        <div class="user-form__div">
            ...
            <input class="input input-w" type="text" name="username" v-model="user.username" placeholder="Enter Username" :disabled="showView && !showModify && !showCreate">
            <label for="password" class="user-form__label">Password</label>
            <input class="input input-w" type="password" name="password" v-model="user.password" placeholder="Enter Password" :disabled="showView && !showModify && !showCreate">
            <label for="verifyPassword" class="user-form__label">Verify Password</label>
            <input class="input input-w" type="password" name="verifyPassword" v-model="verifyPassword" placeholder="Enter Verify Password" :disabled="showView && !showModify && !showCreate">
            <label for="email" class="user-form__label">Email</label>
            <input class="input input-w" type="text" name="email" v-model="user.email" placeholder="Enter Email" :disabled="showView && !showModify && !showCreate">
            ...
            <div class="user-form__permission-div"> 
                <div class="user-form__permission-div__container">
                    ...
                    <label class="switch">
                        <input name="viewPermission" type="checkbox" v-model="permissions.view" :disabled="showView && !showModify && !showCreate">
                ...
                <div class="user-form__permission-div__container">
                    ...
                    <label class="switch">
                        <input name="editPermission" type="checkbox" v-model="permissions.edit" :disabled="showView && !showModify && !showCreate">
                        <span class="slider round"></span>
                    </label>
                </div>
                ...
                <div class="user-form__permission-div__container">
                    ...
                    <label class="switch">
                        <input name="deletePermission" type="checkbox" v-model="permissions.delete" :disabled="showView && !showModify && !showCreate">
                        <span class="slider round"></span>
                    </label>
                </div>
                ...
                <div class="user-form__permission-div__container">
                    ...
                    <label class="switch">
                        <input name="createPermission" type="checkbox" v-model="permissions.create" :disabled="showView && !showModify && !showCreate">
                        <span class="slider round"></span>
                    </label>
                </div>
            </div>
